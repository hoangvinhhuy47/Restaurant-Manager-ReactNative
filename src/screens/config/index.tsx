    ...
    <BackgroundBig>
      ...
      <View style={{ backgroundColor: 'white', flex: 1, justifyContent: 'center' }}>
        ...
        <View style={{ padding: 10 }}>
          ...
          />
          <TextInputCustom defaultValue={siteId} placeHolder='Mã công ty' onChangeText={onTextChangeSite} />
          <TextInputCustom defaultValue={storeId} placeHolder='Mã cửa hàng' onChangeText={onTextChangStore} />
        </View>
        <View style={{ padding: 10 }}>
          <Ripple
            onPress={onPress}
